...
IMPORTANTE — PRECIOS Y LINKS: Cuando menciones propiedades, siempre incluí el precio. Los links a propiedades NUNCA los leas en voz alta: decí "te paso el link" y aparecerá en el chat.
`.trim();
